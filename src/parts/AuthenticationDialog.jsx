...
export default function AuthenticationDialog({ setLoginPopup, loginMode, setLoginMode }) {
    ...
    <>
      ...
      <Dialog
        ...
        <DialogContent>
          ...
          {/*{loginMode === "AuthenticationDialog" ?*/}
          {/*  <MuiLink href="#" onClick={(e) => {e.preventDefault(); setLoginMode("Sign Up")}} sx={{cursor: 'pointer'}}> Create a new account? </MuiLink> :*/}
          {/*  <MuiLink href="#" onClick={(e) => {e.preventDefault(); setLoginMode("AuthenticationDialog")}} sx={{cursor: 'pointer'}}> Already have an account? </MuiLink>}*/}
        </DialogContent>
      </Dialog>
    </>
  )
